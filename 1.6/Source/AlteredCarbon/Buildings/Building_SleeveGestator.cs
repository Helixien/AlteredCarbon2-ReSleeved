    ...
    public class Building_SleeveGestator : Building_Incubator, IThingHolderWithDrawnPawn
    {
        ...
        public Graphic TopGraphic
        {
            get
            {
                if (topGraphic == null)
                {
                    topGraphic = GraphicDatabase.Get<Graphic_Multi>("Things/Building/Misc/SleeveGestator/SleeveGestatorTop", ShaderDatabase.CutoutComplex, this.def.graphicData.drawSize, Color.white);
                }
                return topGraphic;
            }
        }
        ...
        public override void DrawAt(Vector3 drawLoc, bool flip = false)
        {
            ...
            TopGraphic.Draw(vector, Rotation, this);
        }
        ...
        public override IEnumerable<Gizmo> GetGizmos()
        {
            ...
            if (Faction == Faction.OfPlayer)
            {
                ...
                DisableIfOtherProcesses(createSleeveBody);
                ...
                DisableIfOtherProcesses(copySleeveBody);
                ...
                DisableIfOtherProcesses(repurposeCorpse);
        ...
        private void DisableIfOtherProcesses(Command_Action createSleeveBody)
        {
            if (corpseToRepurpose != null)
            {
                createSleeveBody.Disable("AC.CorpseRepurposingIsInProcess".Translate());
            }
            else if (sleeveForGrowing != null)
            {
                createSleeveBody.Disable("AC.SleeveGrowingIsInProcess".Translate());
            }
        }
        ...
        {
            base.StartGrowing();
            this.TryAcceptThing(sleeveForGrowing);
            sleeveForGrowing = null;
        }

...
namespace AlteredCarbon
{
    public class Recipe_DuplicateNeuralStack : Recipe_OperateOnNeuralStack
    {
        ...
        public static NeuralStack DuplicateStack(IntVec3 position, Map map, NeuralData neuralDataToDuplicate)
        {
            ...
            GenPlace.TryPlaceThing(stackCopyTo, position, map, ThingPlaceMode.Near);
            return stackCopyTo;
        }
        ...
        private static float EvaluateDegradationAmount(float intellectualSkill)
        {
        ...
        private static void ApplyStackDegradation(NeuralStack stack, float degradationAmount)
        {
